  ...
  const topics = [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question:
            "19. Write a JS program to input marks of five subjects and calculate percentage and grade",
        },
        {
          question:
            "20. Write a JS program to input basic salary and calculate Gross salary",
        },
        {
          question:
            "21. Write a JS program to input electricity units and calculate total bill",
        },
      ],
    },
    {
...
// Sample Output: name,sclass,rollno`,
        ...
        {
          question:
            "2. Write a JavaScript program to delete the rollno property from an object and print before/after",
          code: `var student = {
  name: "David Rayy",
  sclass: "VI",
  rollno: 12
  ...
  rollno: 12
        ...
        {
          question:
            "4. Write a JavaScript program to display reading status of books",
          code: `var library = [ 
  {
    author: 'Bill Gates',
...
// ["length", "name", "arguments", "caller", "prototype", "isArray", "observe", "unobserve"]`,
        ...
        {
          question:
            "13. Write a JavaScript function to retrieve all property names (own and inherited)",
        },
        {
          question:
            "14. Write a JavaScript function to retrieve all property values",
        },
        {
          question:
            "15. Write a JavaScript function to convert an object into [key, value] pairs",
        },
        {
          question:
            "16. Write a JavaScript function to swap keys and values in an object",
        },
        {
          question:
            "17. Write a JavaScript function to check if object contains given property",
        },
      ],
    },
  ];
    ...
    <div className="relative min-h-screen bg-slate-950 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-white max-w-6xl mx-auto px-6 py-16">
        ...
        <p className="mt-6 max-w-2xl text-lg text-gray-300 flex items-center justify-center gap-2 text-center">
          ...
          {topics.reduce((acc, topic) => acc + topic.questions.length, 0)}+
          coding challenges 🎯💻
        </p>
