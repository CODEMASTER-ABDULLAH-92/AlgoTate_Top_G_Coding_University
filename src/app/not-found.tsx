...
// import { Home, ArrowRight, Search, Terminal, AlertCircle, RefreshCw, Sparkles } from "lucide-react";
...
//     <div 
//       ref={containerRef}
//       className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-950 px-4 sm:px-6 lg:px-8"
//     >
//       {/* Animated Background Elements */}
//       <div className="absolute inset-0 overflow-hidden">
//         {/* Grid pattern */}
//         <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent_24px,rgba(59,130,246,0.03)_25px,transparent_26px),linear-gradient(180deg,transparent_24px,rgba(59,130,246,0.03)_25px,transparent_26px)] bg-[size:60px_60px]"></div>
        
//         {/* Gradient orbs */}
//         <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-red-500/10 via-purple-500/10 to-transparent rounded-full filter blur-3xl animate-pulse-slow"></div>
//         <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-tr from-blue-500/10 via-cyan-500/10 to-transparent rounded-full filter blur-3xl animate-pulse-slow delay-1000"></div>
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-yellow-500/5 via-orange-500/5 to-transparent rounded-full filter blur-3xl animate-pulse-slow delay-500"></div>

//         {/* Floating particles */}
//         {[...Array(25)].map((_, i) => (
//           <div
//             key={i}
//             className="particle absolute w-1 h-1 bg-red-400/30 rounded-full"
//             style={{
...
//       {/* Error Terminal Effect */}
//       <div className="absolute top-8 left-1/2 -translate-x-1/2 w-full max-w-2xl">
//         <div className="bg-black/50 backdrop-blur-sm border border-red-500/30 rounded-xl p-4 mx-4">
...
//             <div className="text-red-400">✗ ERROR: Requested resource not found in server cache</div>
//             <div className="text-yellow-400">ℹ INFO: Attempting to recover from error...</div>
//           </div>
//         </div>
//       </div>
...
//             <div className="relative bg-gradient-to-br from-gray-900/80 via-black/90 to-gray-950 backdrop-blur-xl border border-red-500/30 rounded-3xl p-8 shadow-2xl shadow-red-500/10 overflow-hidden">
...
//                 <div 
//                   ref={titleRef}
//                   className="text-[180px] lg:text-[240px] font-black leading-none text-center"
//                 >
//                   <span className="bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 bg-clip-text text-transparent glitch-text">
//                     4
//                   </span>
//                   <span className="bg-gradient-to-r from-yellow-500 via-green-500 to-cyan-500 bg-clip-text text-transparent glitch-text">
//                     0
//                   </span>
//                   <span className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 bg-clip-text text-transparent glitch-text">
//                     4
//                   </span>
//                 </div>
...
//                   <div className="text-[180px] lg:text-[240px] font-black leading-none opacity-10">
//                     <span className="text-red-500 translate-x-2">4</span>
//                     <span className="text-green-500 -translate-x-1">0</span>
//                     <span className="text-blue-500 translate-y-2">4</span>
//                   </div>
//                 </div>
//               </div>
...
//                   <div
//                     key={index}
//                     className="error-code p-3 bg-black/40 border border-white/10 rounded-lg font-mono text-sm text-gray-300 hover:border-red-500/50 transition-colors"
//                   >
//                     <div className="flex items-center gap-2">
//                       <div className={`w-2 h-2 rounded-full ${index % 3 === 0 ? 'bg-red-500' : index % 3 === 1 ? 'bg-yellow-500' : 'bg-green-500'} animate-pulse`}></div>
//                       {code}
//                     </div>
//                   </div>
//                 ))}
...
//             <div className="floating-element absolute -top-6 -right-6 w-20 h-20 bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-2xl shadow-2xl flex items-center justify-center transform rotate-12 border-2 border-red-400/40 backdrop-blur-sm">
//               <AlertCircle size={32} className="text-red-400" />
//             </div>
//             <div className="floating-element absolute -bottom-6 -left-6 w-20 h-20 bg-gradient-to-tr from-yellow-500/20 to-green-500/20 rounded-2xl shadow-2xl flex items-center justify-center transform -rotate-12 border-2 border-yellow-400/40 backdrop-blur-sm">
...
//             {/* Debug Info */}
//             <div className="mb-8 p-6 bg-black/40 border border-gray-800 rounded-2xl backdrop-blur-sm">
...
//               <Link
//                 href="/"
//                 className="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold py-4 px-6 rounded-xl hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-1"
//               >
...
//                 className="group relative overflow-hidden bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-4 px-6 rounded-xl hover:shadow-2xl hover:shadow-purple-500/30 transition-all duration-300 transform hover:-translate-y-1"
//               >
...
//                 className="group relative overflow-hidden bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold py-4 px-6 rounded-xl hover:shadow-2xl hover:shadow-green-500/30 transition-all duration-300 transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed"
//               >
...
//             {/* Quick Links */}
//             <div className="mt-8">
//               <h4 className="text-gray-400 mb-4 text-sm font-medium">Popular Destinations</h4>
//               <div className="flex flex-wrap gap-3">
//                 {["Home", "Courses", "Blog", "Docs", "Contact"].map((link) => (
//                   <Link
//                     key={link}
//                     href={`/${link.toLowerCase()}`}
//                     className="px-4 py-2 bg-gray-800/50 border border-gray-700 rounded-lg text-gray-300 hover:border-blue-500/50 hover:text-white transition-all duration-300 hover:scale-105"
//                   >
//                     {link}
//                   </Link>
//                 ))}
...
//           <div className="text-gray-500 text-sm mb-2">Nothing down here either</div>
